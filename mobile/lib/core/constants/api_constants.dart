class ApiConstants {
  ...
  static const bool isProduction = true; // Set to false for local testing
  ...
  static String bookingIntentConfirmUrl(String intentId) =>
      '$baseUrl/bookings/intent/$intentId/confirm';

  static String bookingIntentCancelUrl(String intentId) =>
      '$baseUrl/bookings/intent/$intentId/cancel';
  ...
  static String paymentCallbackUrl(String provider) =>
      '$baseUrl/payments/callback/$provider';
