...
class _HostPaymentsScreenState extends State<HostPaymentsScreen> {
  ...
  Future<void> _loadPayments() async {
    ...
    final payments = await _roomRentalService.getHostPayments(user.id);
  ...
  double get _totalRevenue {
    return _payments
        .where((p) => p.status.value.toLowerCase() == 'paid')
  ...
  double get _thisMonthRevenue {
    ...
    return _payments
        .where((p) =>
            p.status.value.toLowerCase() == 'paid' &&
            p.paidAt != null &&
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            PriceFormatter.formatPriceInteger(amount.toInt()),
            style: TextStyle(
              fontSize: 18,
