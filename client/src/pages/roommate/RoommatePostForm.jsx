        ...
        const fetchPostData = async () => {
            if (isEditMode && postId) {
                try {
                    ...
                    const response = await fetch(`${API_BASE_URL}/roommate/posts/${postId}`);
        ...
        const checkVerification = async () => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/identity-verification/${userId}/status`
                );
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const endpoint = isEditMode
                ...
                : `${API_BASE_URL}/roommate/posts/create`;
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-section">
                            ...
                            <div className="form-group">
                                ...
                                <p className="help-text">Upload photos of yourself or the room (max 5 photos, 5MB
                                    each)</p>
