    ...
    const handleConfirmBooking = async () => {
        ...
        try {
            ...
            if (paymentMethod === 'cash') {
                ...
                const response = await fetch(`${API_BASE_URL}/entire-place-booking/create-cash`, {
                    method: 'POST',
                    headers: {
                ...
                const intentResponse = await fetch(`${API_BASE_URL}/entire-place-booking/create-intent`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${localStorage.getItem('token')}`
                ...
                const paymentResponse = await fetch(`${API_BASE_URL}/payment/create-payment-url`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${localStorage.getItem('token')}`
                        ...
                        <div className="payment-options">
                            ...
                            <label className={`payment-option ${paymentMethod === 'vnpay_deposit' ? 'selected' : ''}`}>
                                ...
                                <div className="option-content">
                                    ...
                                    <div className="option-details">
                                        <p>Pay {formatPrice(depositAmount)} VND now, {formatPrice(remainingAmount)} VND
                                            at check-in</p>
                                        <ul>
