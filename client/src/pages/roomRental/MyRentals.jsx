...
import {AlertTriangle, Calendar, CheckCircle, DollarSign, Home, LogOut} from 'lucide-react';
...
const MyRentals = () => {
    ...
    const handleConfirmMoveIn = async (agreementId) => {
        ...
        try {
            const response = await fetch(
                `${API_BASE_URL}/room-rental/move-in/${agreementId}/confirm`,
                {
                    method: 'PUT',
                    headers: {
    ...
    const handleRequestTermination = async () => {
        ...
        try {
            const response = await fetch(
                `${API_BASE_URL}/room-rental-advanced/termination/request`,
                {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
