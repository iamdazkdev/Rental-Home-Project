  ...
  const handleReject = async () => {
    ...
    const fetchRequests = async () => {
        try {
            ...
            console.log('📤 Fetching requests for host:', userId);
            const response = await axios.get(
                `${API_BASE_URL}/room-rental/requests/host/${userId}`
            );
    ...
    const handleApprove = async (requestId) => {
        try {
            setProcessingId(requestId);
            await axios.put(`${API_BASE_URL}/room-rental/requests/${requestId}/approve`, {
                hostId: userId,
                houseRules: '', // Optional, can be added later
                noticePeriod: 30 // Default 30 days notice period
            });
    ...
    const handleReject = async () => {
        ...
        try {
            await axios.put(
                `${API_BASE_URL}/room-rental/requests/${selectedRequest._id}/reject`,
                {
                    hostId: userId,
                    rejectionReason: rejectionReason
                }
                        ...
                        <div className="modal-content" onClick={e => e.stopPropagation()}>
                            ...
                            <div className="modal-body">
                                ...
                                <p className="modal-description">
                                    Please provide a reason for rejecting this rental request. This will be shared with
                                    the tenant.
                                </p>
