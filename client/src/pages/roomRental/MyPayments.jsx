...
import {Banknote, Calendar, CheckCircle, Clock, CreditCard, DollarSign} from 'lucide-react';
...
const MyPayments = () => {
    ...
    const fetchPayments = async () => {
        try {
            ...
            const response = await fetch(
                `${API_BASE_URL}/room-rental-advanced/payments/tenant/${user.id || user._id}`,
                {
                    headers: {
    ...
    const handlePayOnline = async (paymentId) => {
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/payment/create-payment-url`, {
                method: 'POST',
                headers: {
