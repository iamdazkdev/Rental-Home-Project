...
const HostApplicationDashboard = () => {
    ...
    const fetchApplications = useCallback(async () => {
        try {
            ...
            const response = await axios.get(
                `${API_BASE_URL}/room-rental/applications/host/${user._id}`
            );
    ...
    const handleReview = async (appId, decision, notes) => {
        try {
            await axios.post(
                `${API_BASE_URL}/room-rental/applications/${appId}/review`,
                {decision, notes}
            );
    ...
    const handleScheduleInterview = async (appId, interviewData) => {
        try {
            await axios.post(
                `${API_BASE_URL}/room-rental/applications/${appId}/schedule-interview`,
                interviewData
            );
    ...
    const handleMakeOffer = async (appId, offerData) => {
        try {
            await axios.post(
                `${API_BASE_URL}/room-rental/applications/${appId}/make-offer`,
                offerData
            );
