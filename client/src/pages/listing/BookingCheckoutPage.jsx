...
import {API_ENDPOINTS, CONFIG, HTTP_METHODS} from '../../constants/api';
import {getPaymentGatewayLogo, validateBookingData} from '../../utils/paymentUtils';
...
const BookingCheckoutPage = () => {
    ...
    const handleConfirmPayment = async () => {
        ...
        // Always ensure customerId is set from current logged-in user (fallback in case it was missing)
        const resolvedCustomerId = bookingData.customerId || user?._id || user?.id;
        console.log("🔑 Resolved customerId:", resolvedCustomerId, "| from bookingData:", bookingData.customerId, "| from user:", user?._id || user?.id);
        const enrichedBookingData = {...bookingData, customerId: resolvedCustomerId};

        // Validate booking data
        const validation = validateBookingData(enrichedBookingData);
        if (!validation.isValid) {
            alert(`Invalid booking data:\n${validation.errors.join('\n')}`);
            return;
        }

        // Use enriched data from here on
        ...
        try {
            ...
            let paymentAmount = enrichedBookingData.totalPrice;
            let depositPercentage = 0;

            if (paymentMethod === 'vnpay_deposit') {
                depositPercentage = 30; // 30% deposit
                paymentAmount = enrichedBookingData.totalPrice * 0.3;
            }
                                ...
                                >
                                    ...
                                    <div className="option-details">
                                        ...
                                        <div className="benefits">
                                            ...
                                            <span
                                                className="benefit-item">⚠️ Please bring sufficient cash at check-in</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="payment-method">
                                    ...
                                    {paymentMethod === 'vnpay_deposit' && (
                                        <div className="deposit-notice">
                                            <p>💡 You will pay <strong>{formatVND(totalPrice * 0.3)} VND</strong> (30% of
                                                total value)</p>
                        ...
                        {paymentMethod === 'cash' && (
                            <div className="cash-payment-info">
                                ...
                                <div className="info-content">
                                    ...
                                    <ul>
                                        <li>Please bring sufficient cash (<strong>{formatVND(totalPrice)} VND</strong>)
                                            at check-in
                                        </li>
