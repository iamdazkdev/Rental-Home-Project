    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(
                `${API_BASE_URL}/booking/${booking._id}/record-payment`,
                {
                    method: 'POST',
                    headers: {
        ...
        <div className="record-payment-modal-overlay">
            <div className="record-payment-modal">
                ...
                <div className="booking-info">
                    ...
                    <p><strong>Total Remaining:</strong> <span
                        className="highlight">{formatAmount(booking?.remainingAmount)} VND</span></p>
                </div>
