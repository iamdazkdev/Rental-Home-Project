...
class VNPayService {
    constructor() {
        ...
        this.vnp_ReturnUrl = process.env.VNP_RETURN_URL || 'https://rental-home-project-qssf.onrender.com/payment/vnpay-return';
        this.vnp_IpnUrl = process.env.VNP_IPN_URL || 'https://rental-home-project-qssf.onrender.com/payment/vnpay-ipn';
    }
